...
func RegisterChatHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ChatServer) error {
	...
	mux.Handle("GET", pattern_Chat_GetChats_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Chat_GetChats_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Chat_GetChats_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterChatHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ChatClient) error {
	...
	mux.Handle("GET", pattern_Chat_GetChats_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Chat_GetChats_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Chat_GetChats_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"chats"}, "", runtime.AssumeColonVerbOpt(true)))
)
